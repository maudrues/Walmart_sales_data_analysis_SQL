...
SELECT city, AVG(VAT) AS CNT
FROM sales
GROUP BY city
ORDER BY CNT DESC;

-- Which customer type pays the most in VAT
SELECT customer_type , AVG(VAT)as cnt
FROM sales
GROUP BY customer_type
ORDER BY cnt DESC;


-- EDA Customer questions----------------------------------------------------------
-- How many unique customer types doest the data have?
...
SELECT customer_type, sum(quantity) AS CNT
FROM sales
GROUP BY customer_type
ORDER BY CNT DESC;
